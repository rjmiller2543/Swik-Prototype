...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSLog(@"-> popovertableviewcontroller viewdidload");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PopoverTableViewCell *cell = [[PopoverTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    // Configure the cell...
